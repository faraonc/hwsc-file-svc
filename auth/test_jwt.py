...
@pytest.mark.parametrize("input_token, expectation, description",
                         [
                             (
                                     ...
                                     does_not_raise(), "test valid token length"),
                             (
                                     ...
                                     pytest.raises(ValueError), "test invalid token with missing 1 element"),
                             ("eyJBbGciOjIsIlRva2VuVHlwIjoxfQ", pytest.raises(ValueError),
                              "test invalid token with missing 2 elements"),
...
@pytest.mark.parametrize("permission, alg, expectation, description",
                         [
                             (jwt.PermissionEnum.ADMIN, jwt.AlgEnum.HS512, does_not_raise(),
                              "test matched permission with alg"),
                             (jwt.PermissionEnum.ADMIN, jwt.AlgEnum.MIN, pytest.raises(ValueError),
                              "test unmatched Permission with Alg"),
                             (jwt.PermissionEnum.ADMIN, jwt.AlgEnum.NO_ALG, pytest.raises(ValueError),
                              "test unmatched Permission with Alg"),
                             (jwt.PermissionEnum.ADMIN, jwt.AlgEnum.HS256, pytest.raises(ValueError),
                              "test unmatched Permission with Alg"),
                             (jwt.PermissionEnum.ADMIN, jwt.AlgEnum.MAX, pytest.raises(ValueError),
                              "test unmatched Permission with Alg"),
                         ]
                         )
...
@pytest.mark.parametrize("req_permission, token_permission, expectation, description",
                         [
                             (jwt.PermissionEnum.MIN, jwt.PermissionEnum.USER_REGISTRATION, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.NO_PERMISSION, jwt.PermissionEnum.USER_REGISTRATION, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.USER_REGISTRATION, jwt.PermissionEnum.USER_REGISTRATION,
                              does_not_raise(), "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.MIN, jwt.PermissionEnum.USER, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.NO_PERMISSION, jwt.PermissionEnum.USER, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.USER_REGISTRATION, jwt.PermissionEnum.USER, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.USER, jwt.PermissionEnum.USER, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.MIN, jwt.PermissionEnum.ADMIN, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.NO_PERMISSION, jwt.PermissionEnum.ADMIN, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.USER_REGISTRATION, jwt.PermissionEnum.ADMIN, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.USER, jwt.PermissionEnum.ADMIN, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.ADMIN, jwt.PermissionEnum.ADMIN, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.MIN, jwt.PermissionEnum.MAX, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.NO_PERMISSION, jwt.PermissionEnum.MAX, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.USER_REGISTRATION, jwt.PermissionEnum.MAX, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.USER, jwt.PermissionEnum.MAX, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.ADMIN, jwt.PermissionEnum.MAX, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.MAX, jwt.PermissionEnum.MAX, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.MIN, jwt.PermissionEnum.MIN, does_not_raise(),
                              "test req_permission <= token_permission"),
                             (jwt.PermissionEnum.MAX, jwt.PermissionEnum.MIN, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.MAX, jwt.PermissionEnum.NO_PERMISSION, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.MAX, jwt.PermissionEnum.USER_REGISTRATION, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.MAX, jwt.PermissionEnum.USER, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.MAX, jwt.PermissionEnum.ADMIN, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.ADMIN, jwt.PermissionEnum.MIN, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.ADMIN, jwt.PermissionEnum.NO_PERMISSION, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.ADMIN, jwt.PermissionEnum.USER_REGISTRATION, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.ADMIN, jwt.PermissionEnum.USER, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.USER, jwt.PermissionEnum.MIN, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.USER, jwt.PermissionEnum.NO_PERMISSION, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.USER, jwt.PermissionEnum.USER_REGISTRATION, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.USER_REGISTRATION, jwt.PermissionEnum.MIN, pytest.raises(ValueError),
                              "test req_permission > token_permission"),
                             (jwt.PermissionEnum.USER_REGISTRATION, jwt.PermissionEnum.NO_PERMISSION,
                              pytest.raises(ValueError), "test req_permission > token_permission"),
                         ]
                         )
